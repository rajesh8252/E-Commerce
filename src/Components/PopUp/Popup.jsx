    ...
    <>  {orderPopUp&&(
            <div className='popup'>
                <div className='h-screen w-screen fixed top-0 left-0 bg:black/50 backdrop-blur-sm z-50'>
                        ...
                        shadow-md bg-white dark:bg-gray-900 rounded duration-200 w-[300px]'>
                            {/* Header */}
                            ...
                            <div className='mt-4'>
                                    ...
                                    className='w-full rounded-full border-gray-300 border
                                    dark:bg-gray-800
                                    ...
                                    dark:bg-gray-800
                                    border dark:border-gray-500 px-2 py-1 mb-4'/>
